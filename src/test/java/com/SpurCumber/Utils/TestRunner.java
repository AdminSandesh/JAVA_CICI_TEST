...
@CucumberOptions(features = {"src/test/java/com/SpurCumber/Features"},
        ...
        plugin = {"com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:","pretty", "json:test-output/Cucumber.json", "pretty", "io.qameta.allure.cucumber7jvm.AllureCucumber7Jvm" })
